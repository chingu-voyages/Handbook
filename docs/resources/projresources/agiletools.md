...
An important success factor for any team is having all project information available when it's needed. This primarily includes the Product Backlog as well as any project documents like lists and diagrams. Chingu doesn't require that a specific tool be used to manage these. Only that they be available to everyone on a team.
