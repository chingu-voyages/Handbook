...
---
  block-beta
    ...
    block:B0:1
      ...
      A9 -- "<a href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#9-create-a-low-fidelity-wireframe-%EF%B8%8F">Create</br>UI/UX</br>design</a>" --> SPRINT2
