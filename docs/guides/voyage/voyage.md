...
```mermaid
  kanban
    column1[Sprint 0]
      ...
      Review & discuss project["<a style="background-color:#292d30" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#3-review-and-discuss-project-‍%E2%80%8D">Review & discuss project</a>"]
