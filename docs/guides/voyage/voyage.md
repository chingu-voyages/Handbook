...
---
  block-beta
    ...
    block:B0:1
      ...
      A1 -- "<a style="background-color:#646C71 a-visited:white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#1-meet-your-team--schedule-kickoff-meeting-">Meet team &</br>schedule</br>Kickoff</a>" --> SPRINT0
      ...
      A5 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#5-select-a-tech-stack">Select a</br>tech</br>stack</a>" --> SPRINT1
      A6 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#6-add-your-info-to-the-team-list-in-your-readmemd-%EF%B8%8F">Update</br>readme.md</br>team list<a/>" --> SPRINT1
      A7 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#7-define--prioritize-mvp-features-">Define &</br>prioritize</br>features</a>" --> SPRINT1
      A8 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#8-setup-product-backlog-">Create</br>Product</br>Backlog</a>" --> SPRINT1
      A9 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#9-create-a-low-fidelity-wireframe-%EF%B8%8F">Create</br>UI/UX design</a>" --> SPRINT2
      A10 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#10-sprint-3-5---reaching-your-mvp-">Design, code,</br>test & deploy</a>" --> SPRINTS35
      A11 -- "<a style="background-color: white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#11-sprint-3-5---reaching-your-mvp-">Project Closure</a>" --> SPRINT6
    end
