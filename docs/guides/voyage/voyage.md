...
---
  block-beta
    ...
    block:B0:1
      ...
      A1 -- "<a style="background-color: #646C71 a-link:white" href="https://github.com/chingu-voyages/Handbook/blob/main/docs/guides/voyage/voyage.md#1-meet-your-team--schedule-kickoff-meeting-">Meet team &</br>schedule</br>Kickoff</a>" --> SPRINT0
